...
void procesarArchivos(char * imagen1, char *imagen2, char *mask, int ancho, int alto, char * fileName);
...
void procesarArchivos(char * imagen1, char *imagen2, char *mask, int ancho, int alto, char * fileName) {
    ...
    char * coolFileName  = getAFancyFileName(imagen1,fileName);
  ...
  while (elemento!=NULL) {
    ...
    nombreCompleto = getFullName(ruta, elemento);
     // elemento->d_name;
      ...
      procesarArchivos(imagen2, nombreCompleto, mask, ancho, alto, elemento->d_name);
    }
