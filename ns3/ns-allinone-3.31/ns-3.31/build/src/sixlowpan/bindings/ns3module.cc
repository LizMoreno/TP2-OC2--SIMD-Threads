...
PyObject *
_wrap_PyNs3SixLowPanIphc_GetDstAddress(PyNs3SixLowPanIphc *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
PyObject *
_wrap_PyNs3SixLowPanIphc_GetSrcAddress(PyNs3SixLowPanIphc *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    PyNs3Ipv6Address *py_Ipv6Address;
